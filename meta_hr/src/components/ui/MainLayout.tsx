...
import { UserCircle2, LayoutDashboard, Users2, ShieldCheck, Briefcase, ChevronRight, Home, LogOut, Layout, Settings } from 'lucide-react';
...
export default function MainLayout({ children }: MainLayoutProps) {
    ...
    const navGroups: NavGroup[] = [
        ...
        },
        {
            ...
            items: [
                { label: 'Employee Hub', href: '/employees', icon: Users2, roles: ['super_admin', 'admin'] },
                { label: 'Token Manager', href: '/tokens', icon: ShieldCheck, roles: ['super_admin', 'admin'] },
